...
class NodeAttrMask():
    ...
    '''
    def __init__(self, mode='whole', mask_ratio=0.2, mask_mean=0.5, mask_std=0.5, return_mask=False):
        self.mode = mode
    ...
    def do_trans(self, data):
        ...
        if self.mode == 'whole':
            ...
            idx_mask = np.random.choice(node_num, mask_num, replace=False) # idx of masking node
            x[idx_mask] = 0
            mask[idx_mask] = 1
