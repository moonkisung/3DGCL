...
aug_1-MMFFrandom_aug_2-MMFFrandom_aug_ratio-0.25_tau-0.2_optim-ExponentialLR_weight_decay-0_expo_gamma-0.95_dropout-0.0/enc_best_epoch-273_loss-12.051.pkl'
...
args.z_dim_lst = [512]
args.dropout_rate_lst = [0.3, 0.0, 0.1, 0.2, 0.3]
args.target_lst = ['y']
args.f_lr_lst = [1e-3]
args.f_weight_decay_lst = [0, 5e-5, 5e-4]
# , 1e-3, 5e-5, 1e-4, 1e-5]
